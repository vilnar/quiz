...
const QUIZ_NAME = "quiz_adaptability_200"
const QUIZ_LABEL = "Адаптивність 200"
const QUIZ_SHORT_LABEL = "Адаптивність 200"
...
func renderResult(w http.ResponseWriter, q quiz.QuizDb) {
	...
	tmpl, err := template.New("adaptability_200_result.html").Funcs(funcMap).ParseFiles(
		path.Join(common.GetProjectRootPath(), "quiz", "ui", "templates", "quiz", "adaptability_200_result.html"),
